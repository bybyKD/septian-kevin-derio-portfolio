...
<ComponentPreview
  ...
  openInV0Url="https://septian-kevin-derio-portfolio.vercel.app/r/fluid-gradient-text.json"
  customizeUrl="https://septian-kevin-derio-portfolio.vercel.app/preview/fluid-gradient-text-dialkit"
/>
...
```bash
npx shadcn@latest add @septian-kevin-derio/fluid-gradient-text
```
