...
<ComponentPreview
  ...
  openInV0Url="https://septian-kevin-derio-portfolio.vercel.app/r/share-menu.json"
/>
...
```bash
npx shadcn@latest add @septian-kevin-derio/share-menu
```
...
```tsx
<ShareMenu
  title="septian-kevin-derio-portfolio.vercel.app"
  url="https://septian-kevin-derio-portfolio.vercel.app"
/>
```
