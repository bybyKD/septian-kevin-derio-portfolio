...
<ComponentPreview
  ...
  openInV0Url="https://septian-kevin-derio-portfolio.vercel.app/r/glow-card-grid-demo.json"
  customizeUrl="https://septian-kevin-derio-portfolio.vercel.app/preview/glow-card-grid-dialkit"
/>
...
```bash
npx shadcn@latest add @septian-kevin-derio/glow-card-grid
```
