...
<ComponentPreview
  name="twemoji-demo"
  openInV0Url="https://septian-kevin-derio-portfolio.vercel.app/r/twemoji.json"
/>
...
```bash
npx shadcn@latest add @septian-kevin-derio/twemoji
```
...
[lib/twemoji-regex.ts](https://github.com/bybyKD/septian-kevin-derio-portfolio/blob/main/src/registry/components/twemoji/lib/twemoji-regex.ts)
