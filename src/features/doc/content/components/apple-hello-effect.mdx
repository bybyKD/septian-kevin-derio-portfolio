...
<ComponentPreview
  ...
  openInV0Url="https://septian-kevin-derio-portfolio.vercel.app/r/apple-hello-effect.json"
  canReplay
/>
...
```bash
npx shadcn@latest add @septian-kevin-derio/apple-hello-effect
```

For Hindi:

```bash
npx shadcn@latest add @septian-kevin-derio/apple-hello-effect-hindi
```

For Spanish:

```bash
npx shadcn@latest add @septian-kevin-derio/apple-hello-effect-spanish
```

For Vietnamese:

```bash
npx shadcn@latest add @septian-kevin-derio/apple-hello-effect-vietnamese
```
