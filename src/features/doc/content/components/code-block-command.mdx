...
<ComponentPreview
  ...
  openInV0Url="https://septian-kevin-derio-portfolio.vercel.app/r/code-block-command.json"
/>
...
```bash
npx shadcn@latest add @septian-kevin-derio/code-block-command
```
...
```bash
npm install cn class-variance-authority lucide-react motion jotai @base-ui/react
```
...
- [Copy Button](https://septian-kevin-derio-portfolio.vercel.app/components/copy-button)

<Step>Copy and paste the following code into your project</Step>

<ComponentSource src="src/components/ui/tabs.tsx" title="components/tabs.tsx" />
