...
<ComponentPreview
  ...
  openInV0Url="https://septian-kevin-derio-portfolio.vercel.app/r/wheel-picker.json"
/>
...
<DocTestimonial
  ...
  quote="See @septiankevin_derio Wheel Picker. It’s on the registry. Quick install."
/>
...
```bash
npx shadcn@latest add @septian-kevin-derio/wheel-picker
```
