...
<ComponentPreview
  ...
  openInV0Url="https://septian-kevin-derio-portfolio.vercel.app/r/spinning-circular-text.json"
/>
...
```bash
npx shadcn@latest add @septian-kevin-derio/spinning-circular-text
```
...
```tsx
<SpinningCircularText text="Built with care by derio • " />
```
