export const registryConfig = {
   ...
   * @example "@septian-kevin-derio" - Users can install components with: `npx shadcn add @septian-kevin-derio/wheel-picker`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace:
    process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@septian-kevin-derio",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://septian-kevin-derio-portfolio.vercel.app/r/{name}.json" resolves to "https://septian-kevin-derio-portfolio.vercel.app/r/wheel-picker.json"
  ...
  namespaceUrl:
    ...
    "https://septian-kevin-derio-portfolio.vercel.app/r/{name}.json",
}
